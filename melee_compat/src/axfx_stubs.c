...
int AXFXReverbHiInit(struct AXFX_REVERBHI* r)
{
    COMPAT_STUB();
    (void) r;
    return 0;
}
int AXFXReverbHiShutdown(struct AXFX_REVERBHI* r)
{
    (void) r;
    return 0;
}
int AXFXReverbHiSettings(struct AXFX_REVERBHI* r)
{
    (void) r;
    return 0;
}
...
int AXFXReverbStdInit(struct AXFX_REVERBSTD* r)
{
    COMPAT_STUB();
    (void) r;
    return 0;
}
int AXFXReverbStdShutdown(struct AXFX_REVERBSTD* r)
{
    (void) r;
    return 0;
}
int AXFXReverbStdSettings(struct AXFX_REVERBSTD* r)
{
    (void) r;
    return 0;
}
